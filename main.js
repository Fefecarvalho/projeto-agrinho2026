document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================================
    // 3. CARROSSEL AUTOMÁTICO (Com trava de segurança)
    // ==========================================================================
    ...
    // ==========================================================================
    // 5. QUIZ DA SUSTENTABILIDADE (Com trava de segurança)
    // ==========================================================================
    const quizQuestions = [
        {
    ...
    if (btnCalc && inputArea && calcResult) {
    ...
    const cenariosClima = {
        ...
        chuva: "🌧️ <strong>Automatização ativada:</strong> Com a Chuva Forte, o sistema inteligente de irrigação é totalmente desligado para evitar encharcamento das raíces e o desperdício de energia.",
    ...
    climaButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (climaResult && cenariosClima[tipoClima]) {
